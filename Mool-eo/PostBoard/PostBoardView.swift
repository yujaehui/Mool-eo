...
class PostBoardView: BaseView {
    let collectionView: UICollectionView = {
        let collectionView = UICollectionView(frame: .zero, collectionViewLayout: configureCollectionViewLayout())
        collectionView.register(PostBoardCollectionViewCell.self, forCellWithReuseIdentifier: PostBoardCollectionViewCell.identifier)
